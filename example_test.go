...
func ExampleNewFrontEndHTTPSHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewFrontEndHTTPSHeader()
	fmt.Println(header)
}
...
func ExampleNewHTTP2SettingsHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewHTTP2SettingsHeader()
	fmt.Println(header)
}
...
func ExampleNewIfMatchHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewIfMatchHeader()
	fmt.Println(header)
}
...
func ExampleNewIfModifiedSinceHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewIfModifiedSinceHeader()
	fmt.Println(header)
}
...
func ExampleNewIfNoneMatchHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewIfNoneMatchHeader()
	fmt.Println(header)
}
...
func ExampleNewIfRangeHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewIfRangeHeader()
	fmt.Println(header)
}
...
func ExampleNewIfUnmodifiedSinceHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewIfUnmodifiedSinceHeader()
	fmt.Println(header)
}
...
func ExampleNewKeepAliveHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewKeepAliveHeader()
	fmt.Println(header)
}
...
func ExampleNewLargeAllocationHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewLargeAllocationHeader()
	fmt.Println(header)
}
...
func ExampleNewLastModifiedHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewLastModifiedHeader()
	fmt.Println(header)
}
...
func ExampleNewLocationHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewLocationHeader()
	fmt.Println(header)
}
...
func ExampleNewMaxForwardsHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewMaxForwardsHeader()
	fmt.Println(header)
}
...
func ExampleNewOriginHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewOriginHeader()
	fmt.Println(header)
}
...
func ExampleNewPermissionsPolicyHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewPermissionsPolicyHeader()
	fmt.Println(header)
}
...
func ExampleNewPragmaHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewPragmaHeader()
	fmt.Println(header)
}
...
func ExampleNewPreferHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewPreferHeader()
	fmt.Println(header)
}
...
func ExampleNewPreferenceAppliedHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewPreferenceAppliedHeader()
	fmt.Println(header)
}
...
func ExampleNewProxyAuthenticateHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewProxyAuthenticateHeader()
	fmt.Println(header)
}
...
func ExampleNewProxyAuthorizationHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewProxyAuthorizationHeader()
	fmt.Println(header)
}
...
func ExampleNewProxyConnectionHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewProxyConnectionHeader()
	fmt.Println(header)
}
...
func ExampleNewPublicKeyPinsHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewPublicKeyPinsHeader()
	fmt.Println(header)
}
...
func ExampleNewRangeHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewRangeHeader()
	fmt.Println(header)
}
...
func ExampleNewRefererHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewRefererHeader()
	fmt.Println(header)
}
...
func ExampleNewReferrerPolicyHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewReferrerPolicyHeader()
	fmt.Println(header)
}
...
func ExampleNewRefreshHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewRefreshHeader()
	fmt.Println(header)
}
...
func ExampleNewReportToHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewReportToHeader()
	fmt.Println(header)
}
...
func ExampleNewRetryAfterHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewRetryAfterHeader()
	fmt.Println(header)
}
...
func ExampleNewSaveDataHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewSaveDataHeader()
	fmt.Println(header)
}
...
func ExampleNewSecCHPrefersColorSchemeHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewSecCHPrefersColorSchemeHeader()
	fmt.Println(header)
}
...
func ExampleNewSecCHPrefersReducedMotionHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewSecCHPrefersReducedMotionHeader()
	fmt.Println(header)
}
...
func ExampleNewSecCHPrefersReducedTransparencyHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewSecCHPrefersReducedTransparencyHeader()
	fmt.Println(header)
}
...
func ExampleNewSecCHUAHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewSecCHUAHeader()
	fmt.Println(header)
}
...
func ExampleNewSecCHUAArchHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewSecCHUAArchHeader()
	fmt.Println(header)
}
...
func ExampleNewSecCHUABitnessHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewSecCHUABitnessHeader()
	fmt.Println(header)
}
...
func ExampleNewSecCHUAFullVersionHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewSecCHUAFullVersionHeader()
	fmt.Println(header)
}
...
func ExampleNewSecCHUAFullVersionListHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewSecCHUAFullVersionListHeader()
	fmt.Println(header)
}
...
func ExampleNewSecCHUAMobileHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewSecCHUAMobileHeader()
	fmt.Println(header)
}
...
func ExampleNewSecCHUAModelHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewSecCHUAModelHeader()
	fmt.Println(header)
}
...
func ExampleNewSecCHUAPlatformHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewSecCHUAPlatformHeader()
	fmt.Println(header)
}
...
func ExampleNewSecCHUAPlatformVersionHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewSecCHUAPlatformVersionHeader()
	fmt.Println(header)
}
...
func ExampleNewSecFetchDestHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewSecFetchDestHeader()
	fmt.Println(header)
}
...
func ExampleNewSecFetchModeHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewSecFetchModeHeader()
	fmt.Println(header)
}
...
func ExampleNewSecFetchSiteHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewSecFetchSiteHeader()
	fmt.Println(header)
}
...
func ExampleNewSecFetchUserHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewSecFetchUserHeader()
	fmt.Println(header)
}
...
func ExampleNewSecGPCHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewSecGPCHeader()
	fmt.Println(header)
}
...
func ExampleNewSecPurposeHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewSecPurposeHeader()
	fmt.Println(header)
}
...
func ExampleNewSecWebSocketAcceptHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewSecWebSocketAcceptHeader()
	fmt.Println(header)
}
...
func ExampleNewServerHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewServerHeader()
	fmt.Println(header)
}
...
func ExampleNewServerTimingHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewServerTimingHeader()
	fmt.Println(header)
}
...
func ExampleNewServiceWorkerNavigationPreloadHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewServiceWorkerNavigationPreloadHeader()
	fmt.Println(header)
}
...
func ExampleNewSetCookieHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewSetCookieHeader()
	fmt.Println(header)
}
...
func ExampleNewSourceMapHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewSourceMapHeader()
	fmt.Println(header)
}
...
func ExampleNewStatusHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewStatusHeader()
	fmt.Println(header)
}
...
func ExampleNewStrictTransportSecurityHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewStrictTransportSecurityHeader()
	fmt.Println(header)
}
...
func ExampleNewTimingAllowOriginHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewTimingAllowOriginHeader()
	fmt.Println(header)
}
...
func ExampleNewTrailerHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewTrailerHeader()
	fmt.Println(header)
}
...
func ExampleNewTransferEncodingHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewTransferEncodingHeader()
	fmt.Println(header)
}
...
func ExampleNewUpgradeHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewUpgradeHeader()
	fmt.Println(header)
}
...
func ExampleNewUpgradeInsecureRequestsHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewUpgradeInsecureRequestsHeader()
	fmt.Println(header)
}
...
func ExampleNewUserAgentHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewUserAgentHeader()
	fmt.Println(header)
}
...
func ExampleNewViewportWidthHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewViewportWidthHeader()
	fmt.Println(header)
}
...
func ExampleNewWWWAuthenticateHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewWWWAuthenticateHeader()
	fmt.Println(header)
}
...
func ExampleNewWantDigestHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewWantDigestHeader()
	fmt.Println(header)
}
...
func ExampleNewWarningHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewWarningHeader()
	fmt.Println(header)
}
...
func ExampleNewWidthHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewWidthHeader()
	fmt.Println(header)
}
...
func ExampleNewXATTDeviceIDHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewXATTDeviceIDHeader()
	fmt.Println(header)
}
...
func ExampleNewXContentDurationHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewXContentDurationHeader()
	fmt.Println(header)
}
...
func ExampleNewXContentSecurityPolicyHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewXContentSecurityPolicyHeader()
	fmt.Println(header)
}
...
func ExampleNewXContentTypeOptionsHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewXContentTypeOptionsHeader()
	fmt.Println(header)
}
...
func ExampleNewXCorrelationIDHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewXCorrelationIDHeader()
	fmt.Println(header)
}
...
func ExampleNewXCSRFTokenHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewXCSRFTokenHeader()
	fmt.Println(header)
}
...
func ExampleNewXDNSPrefetchControlHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewXDNSPrefetchControlHeader()
	fmt.Println(header)
}
...
func ExampleNewXForwardedForHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewXForwardedForHeader()
	fmt.Println(header)
}
...
func ExampleNewXForwardedHostHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewXForwardedHostHeader()
	fmt.Println(header)
}
...
func ExampleNewXForwardedProtoHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewXForwardedProtoHeader()
	fmt.Println(header)
}
...
func ExampleNewXFrameOptionsHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewXFrameOptionsHeader()
	fmt.Println(header)
}
...
func ExampleNewXHTTPMethodOverrideHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewXHTTPMethodOverrideHeader()
	fmt.Println(header)
}
...
func ExampleNewXPoweredByHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewXPoweredByHeader()
	fmt.Println(header)
}
...
func ExampleNewXRedirectByHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewXRedirectByHeader()
	fmt.Println(header)
}
...
func ExampleNewXRequestIDHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewXRequestIDHeader()
	fmt.Println(header)
}
...
func ExampleNewXRequestedWithHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewXRequestedWithHeader()
	fmt.Println(header)
}
...
func ExampleNewXUACompatibleHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewXUACompatibleHeader()
	fmt.Println(header)
}
...
func ExampleNewXWapProfileHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewXWapProfileHeader()
	fmt.Println(header)
}
...
func ExampleNewXWebKitCSPHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewXWebKitCSPHeader()
	fmt.Println(header)
}
...
func ExampleNewXXSSProtectionHeader() {
	// Create a new HTTP header for use in HTTP client.
	header := goheader.NewXXSSProtectionHeader()
	fmt.Println(header)
}
